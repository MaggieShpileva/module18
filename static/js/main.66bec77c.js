/*! For license information please see main.66bec77c.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, t, n) => {
        ...
        function Aa() {
          if (!Ba && null !== Ia) {
            ...
            try {
              ...
              throw (null !== Ia && (Ia = Ia.slice(e + 1)), Ke(Ze, Aa), a);
            } finally {
              (bt = t), (Ba = !1);
            }
          }
        ...
        function Yl(e, t) {
          switch ((_a(Kl, t), _a(Ql, e), _a(Hl, Wl), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function cs(e) {
          ...
          try {
            ...
            (bt = r), (Pu.transition = n), 0 === (6 & (Nu = t)) && Aa();
          }
        }
        function fs() {
          (Ru = Ou.current), Ca(Ou);
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 === (32768 & t.flags))) {
              if (null !== (n = Ki(n, t, Ru))) return void (Tu = n);
            } else {
              if (null !== (n = qi(n, t)))
  ...
  (n.m = e),
    ...
    (n.u = (e) => "static/js/" + e + ".dac6f0e7.chunk.js"),
    (n.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self.webpackChunkmodule18 = self.webpackChunkmodule18 || []);
  ...
  const i = () =>
    (0, o.jsx)("footer", {
      children: (0, o.jsxs)("div", {
        className: "container",
        children: [
          (0, o.jsx)("h4", { children: "My project" }),
          (0, o.jsx)("p", { children: "\xa9 created by urban" }),
        ],
      }),
    });
  var u,
  ...
  function b(e, t, n, r) {
    ...
    function y() {
      ...
      let e = h(),
        t = null == e ? null : e - c;
      (c = e), s && s({ action: i, location: w.location, delta: t });
    }
    function b(e) {
      let t =
    ...
    null == c && ((c = 0), o.replaceState(f({}, o.state, { idx: c }), ""));
    let w = {
      get action() {
        return i;
      },
      ...
      push: function (e, t) {
        ...
        l && s && s({ action: i, location: w.location, delta: 1 });
      },
      replace: function (e, t) {
        ...
        let a = m(r, c),
          f = w.createHref(r);
        o.replaceState(a, "", f),
          l && s && s({ action: i, location: w.location, delta: 0 });
      },
      go: (e) => o.go(e),
    };
    return w;
  ...
  function k(e, t, n) {
    void 0 === n && (n = "/");
    let r = M(("string" === typeof t ? y(t) : t).pathname || "/", n);
    if (null == r) return null;
    let a = S(e);
    !(function (e) {
      e.sort((e, t) =>
    ...
    void 0 === r && (r = !1),
      "string" === typeof e
        ...
        : ((a = f({}, e)),
          ...
          p(!a.search || !a.search.includes("#"), D("#", "search", "hash", a)));
    let l,
      o = "" === e || "" === a.pathname,
      i = o ? "/" : a.pathname;
    if (null == i) l = n;
    ...
    let u = (function (e, t) {
        ...
        let {
          ...
          l = n
            ...
            : t;
        return { pathname: l, search: A(r), hash: V(a) };
      })(a, l),
      s = i && "/" !== i && i.endsWith("/"),
      c = (o || "." === i) && n.endsWith("/");
  ...
  function te() {
    return ee() || p(!1), r.useContext(G).location;
  }
  function ne(e) {
    ...
    return e
      ...
      : (function () {
          ...
          let e = r.useContext(q),
            { basename: t, future: n, navigator: a } = r.useContext(X),
            { matches: l } = r.useContext(J),
            { pathname: o } = te(),
            i = JSON.stringify(I(l, n.v7_relativeSplatPath)),
            u = r.useRef(!1);
          return (
            ne(() => {
              u.current = !0;
            ...
            r.useCallback(
              function (n, r) {
                ...
                let l = U(n, JSON.parse(i), o, "path" === r.relative);
                null == e &&
                  "/" !== t &&
  ...
  function ae(e, t) {
    let { relative: n } = void 0 === t ? {} : t,
      { future: a } = r.useContext(X),
      { matches: l } = r.useContext(J),
      { pathname: o } = te(),
      i = JSON.stringify(I(l, a.v7_relativeSplatPath));
    return r.useMemo(() => U(e, JSON.parse(i), o, "path" === n), [e, i, o, n]);
  }
  function le(e, t, n, a) {
    ee() || p(!1);
    let { navigator: l } = r.useContext(X),
  ...
  const ie = r.createElement(oe, null);
  ...
  function ye(e) {
    ...
    return null == b
      ...
      : r.createElement(
          X.Provider,
          { value: f },
          r.createElement(G.Provider, { children: n, value: b })
        );
  }
  function be(e) {
    ...
    return (
      r.Children.forEach(e, (e, a) => {
        ...
        if (e.type === r.Fragment)
          return void n.push.apply(n, we(e.props.children, l));
        e.type !== ge && p(!1), e.props.index && e.props.children && p(!1);
        let o = {
        ...
        e.props.children && (o.children = we(e.props.children, l)), n.push(o);
      }),
      n
    );
  }
  ...
  const _e =
    ...
    Ne = r.forwardRef(function (e, t) {
      let n,
        ...
        h = Se(e, xe),
        { basename: m } = r.useContext(X),
        v = !1;
      if ("string" === typeof c && Pe.test(c) && ((n = c), _e))
        try {
      ...
      let y = (function (e, t) {
          let { relative: n } = void 0 === t ? {} : t;
          ee() || p(!1);
          let { basename: a, navigator: l } = r.useContext(X),
  ...
  const Le = () =>
      (0, o.jsx)("header", {
        children: (0, o.jsxs)("div", {
          className: "container",
          children: [
            (0, o.jsx)("h1", { children: "My project" }),
            (0, o.jsxs)("nav", {
              children: [
                (0, o.jsx)(Ne, { to: "/", children: "HOME" }),
                (0, o.jsx)(Ne, { to: "/about", children: "ABOUT" }),
                (0, o.jsx)(Ne, { to: "/products", children: "PRODUCTS" }),
              ],
            }),
          ],
        }),
    ...
    Re = (e) => {
      ...
      return (0, o.jsxs)(o.Fragment, {
        children: [
          (0, o.jsx)(Le, {}),
          (0, o.jsx)("main", { children: t }),
          (0, o.jsx)(i, {}),
        ],
      });
    },
    Oe = () => (0, o.jsx)("h1", { children: "HOME" }),
    Fe = () => (0, o.jsx)("h1", { children: "About" }),
    Me = () => (0, o.jsx)("h1", { children: "NOT FOUND" }),
    De = (e) => {
      let { data: t } = e;
      return (0, o.jsxs)(Ne, {
        ...
        className: "product",
        children: [
          (0, o.jsx)("img", { src: t.image }),
          (0, o.jsx)("h3", { children: t.title }),
        ],
      });
    },
    je = () => {
      ...
      return (
        ...
        (0, o.jsx)("div", {
          ...
          children:
            null === e
              ? (0, o.jsx)("p", { children: "...loading" })
              : e.map((e) => (0, o.jsx)(De, { data: e })),
        })
      );
    },
    Ie = () => {
      ...
      return (
        (0, r.useEffect)(() => {
          (async () => {
            const t = await fetch(
                "https://fakestoreapi.com/products/".concat(e)
              ),
              r = await t.json();
            n(r);
          })();
        ...
        (0, o.jsxs)(o.Fragment, {
          children: [
            (0, o.jsx)("h1", { children: "\u0422\u043e\u0432\u0430\u0440" }),
            null === t
              ? (0, o.jsx)("p", { children: "...loading" })
              : (0, o.jsxs)("div", {
                  className: "card",
                  children: [
                    (0, o.jsx)("img", { src: t.image, width: "600" }),
                    " ",
                    (0, o.jsx)("p", { children: t.description }),
                    (0, o.jsx)("h3", { children: t.title }),
                    (0, o.jsxs)("h5", { children: [t.price, "$"] }),
                  ],
                }),
          ],
        })
      ...
      return (0, o.jsx)(Ce, {
        children: (0, o.jsx)(Re, {
          children: (0, o.jsxs)(be, {
            children: [
              (0, o.jsx)(ge, { path: "/", element: (0, o.jsx)(Oe, {}) }),
              (0, o.jsx)(ge, { path: "/about", element: (0, o.jsx)(Fe, {}) }),
              (0, o.jsx)(ge, {
                path: "/products",
                element: (0, o.jsx)(je, {}),
              }),
              ...
              (0, o.jsx)(ge, { path: "*", element: (0, o.jsx)(Me, {}) }),
            ],
          }),
        }),
      });
  ...
  l
    ...
    .render((0, o.jsx)(r.StrictMode, { children: (0, o.jsx)(Ue, {}) })),
    Be();
})();
//# sourceMappingURL=main.66bec77c.js.map
